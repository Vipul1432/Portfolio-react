                ...
                <div className="space-y-12">
                    {skills.map((category, categoryIndex) => (
                        <div key={categoryIndex} className="animate-fadeInUp">
                            <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-brand-accent mb-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                                {category.skills.map((skill, skillIndex) => (
                                    <div
                                        key={skillIndex}
                                        className="bg-light-surface dark:bg-dark-surface p-4 sm:p-6 rounded-lg shadow-md hover:shadow-glow transition-all duration-300 transform hover:scale-105"
                                    >
