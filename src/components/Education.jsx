                        ...
                        >
                            <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-6">
                                <div className="flex items-start space-x-4 mb-4 md:mb-0">
                                    ...
                                    <div>
                                        <h3 className="text-2xl font-bold text-brand-accent flex items-center">
                                            <GraduationCap size={24} className="mr-2" />
                                            {edu.degree}
                                        </h3>
                                        <p className="text-xl text-light-primary dark:text-dark-primary font-semibold mt-2">
                                            {edu.institution}
                                        </p>
                                        <div className="flex items-center text-light-secondary dark:text-dark-secondary mt-2">
                                ...
                                <div className="text-right">
                                    ...
                                    <div className="flex items-center justify-end text-brand-accent font-semibold">
