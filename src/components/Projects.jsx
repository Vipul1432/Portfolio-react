            ...
            <div className="max-w-screen-xl mx-auto w-full">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                    {projects.map((project, index) => (
                        ...
                        >
                            {/* Project Thumbnail */}
                            <div className="relative h-40 sm:h-48 bg-gradient-to-br from-brand-accent to-brand-accent-hover overflow-hidden">
                            ...
                            <div className="p-4 sm:p-6">
                                <h3 className="text-xl sm:text-2xl font-bold text-brand-accent mb-3">
                                    {project.title}
                                </h3>
                                ...
                                <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4 mt-6">
                                    {project.githubUrl && (
                                        <a
                                            ...
                                            className="flex items-center justify-center bg-light-primary dark:bg-dark-primary text-light-bg dark:text-dark-bg px-4 py-2 rounded-lg hover:bg-brand-accent hover:text-white transition-all duration-300 font-medium text-sm"
                                        >
                                    ...
                                    {project.liveUrl && (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="flex items-center justify-center bg-brand-accent text-white px-4 py-2 rounded-lg hover:bg-brand-accent-hover transition-all duration-300 font-medium text-sm"
                                        >
